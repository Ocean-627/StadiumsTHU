# Generated by Django 3.1.2 on 2020-12-01 05:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.FloatField(default=4.9, verbose_name='评分')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.IntegerField(null=True, verbose_name='学生编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('court', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.court')),
                ('duration', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.duration')),
                ('stadium', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.stadium')),
        ...
        migrations.AddField(
            model_name='comment',
            name='reserve',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.reserveevent'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
